...
Total rows of raw data is `r format(totalRows,big.mark=",",scientific=FALSE)` and after we omit NA's the total is `r format(totalRowsOmitNAs,big.mark=",",scientific=FALSE) `. We have ommtted `r format(totalRows - totalRowsOmitNAs,big.mark=",",scientific=FALSE)` incomplete records.
